"""
Django settings for UI_remote project.
...
DATABASE_USER = os.getenv('DATABASE_USER', 'remote-ui')
...
SECRET_KEY = 'rjevs76y8y!gu@u241n3p(m1+xoo9z+^kf3_azub*c9-lsm!15'
